...
<template><p>Total price: ${{ cartTotalPrice.toFixed(2) }}</p>

<p v-if="items">Total items: {{ items?.length || 0 }}</p>
<p v-if="cartTotalPrice !== undefined">
  Total price: ${{ cartTotalPrice?.toFixed?.(2) || '0.00' }}
</p></template>
